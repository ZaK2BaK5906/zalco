...
Config.Jobs = {
    ...
    ['mineur'] = {
        ...
        xpPerAction = 2,
        -- Point de depart du job
        startPoint = vector3(2959.54, 2774.36, 39.31),
        -- Points de farm (minerais)
        farmPoints = {
            {coords = vector3(2950.12, 2780.45, 39.31), label = 'Veine de charbon', item = 'charbon', minAmount = 1, maxAmount = 3, time = 8000},
            {coords = vector3(2962.34, 2769.12, 39.31), label = 'Veine de fer', item = 'minerai_fer', minAmount = 1, maxAmount = 2, time = 10000},
            {coords = vector3(2944.67, 2788.23, 39.31), label = 'Veine d\'or', item = 'minerai_or', minAmount = 1, maxAmount = 1, time = 15000},
            {coords = vector3(2970.89, 2762.56, 39.31), label = 'Veine de diamant', item = 'diamant_brut', minAmount = 1, maxAmount = 1, time = 20000},
            {coords = vector3(2938.45, 2795.78, 39.31), label = 'Veine de charbon', item = 'charbon', minAmount = 2, maxAmount = 4, time = 8000},
            {coords = vector3(2978.12, 2755.34, 39.31), label = 'Veine de fer', item = 'minerai_fer', minAmount = 1, maxAmount = 3, time = 10000},
        },
        -- Point de vente
        sellPoint = {
    ...
    ['bucheron'] = {
        ...
        farmPoints = {
            {coords = vector3(-550.23, 5245.67, 74.17), label = 'Arbre a abattre', item = 'bois_brut', minAmount = 2, maxAmount = 5, time = 12000},
            {coords = vector3(-525.45, 5260.89, 74.17), label = 'Arbre a abattre', item = 'bois_brut', minAmount = 2, maxAmount = 5, time = 12000},
            {coords = vector3(-560.78, 5238.12, 74.17), label = 'Arbre a abattre', item = 'bois_brut', minAmount = 3, maxAmount = 6, time = 12000},
            {coords = vector3(-515.34, 5268.45, 74.17), label = 'Recuperer ecorce', item = 'ecorce', minAmount = 1, maxAmount = 3, time = 6000},
            {coords = vector3(-545.67, 5255.23, 74.17), label = 'Recuperer resine', item = 'resine', minAmount = 1, maxAmount = 2, time = 8000},
            {coords = vector3(-532.12, 5248.78, 74.17), label = 'Arbre a abattre', item = 'bois_brut', minAmount = 2, maxAmount = 4, time = 12000},
        },
        sellPoint = {
            coords = vector3(-570.45, 5230.12, 74.17),
            label = 'Vendre bois',
            prices = {
                ['bois_brut'] = 12,
                ['ecorce'] = 8,
    ...
    ['boucher'] = {
        ...
        farmPoints = {
            {coords = vector3(975.34, -2145.67, 30.51), label = 'Depecer boeuf', item = 'viande_boeuf', minAmount = 3, maxAmount = 6, time = 15000},
            {coords = vector3(960.45, -2155.89, 30.51), label = 'Depecer porc', item = 'viande_porc', minAmount = 2, maxAmount = 5, time = 12000},
            {coords = vector3(980.67, -2138.12, 30.51), label = 'Depecer poulet', item = 'viande_poulet', minAmount = 4, maxAmount = 8, time = 8000},
            {coords = vector3(952.89, -2162.34, 30.51), label = 'Recuperer cuir', item = 'cuir_brut', minAmount = 1, maxAmount = 3, time = 10000},
            {coords = vector3(988.12, -2130.56, 30.51), label = 'Depecer agneau', item = 'viande_agneau', minAmount = 2, maxAmount = 4, time = 12000},
            {coords = vector3(945.34, -2168.78, 30.51), label = 'Recuperer cuir', item = 'cuir_brut', minAmount = 2, maxAmount = 4, time = 10000},
        },
        sellPoint = {
    ...
    ['livreur_pizza'] = {
        ...
        -- Pour les livreurs, les farmPoints sont des points de livraison
        deliveryPickup = {
        ...
        bonusTime = 120, -- Bonus si livraison < 2min
        bonusAmount = 50,
    },
...
-- =============================================================================
-- ITEMS (pour reference)
-- =============================================================================

Config.Items = {
    -- Mineur
    'charbon', 'minerai_fer', 'minerai_or', 'diamant_brut',
    -- Bucheron
    'bois_brut', 'ecorce', 'resine',
    -- Boucher
    'viande_boeuf', 'viande_porc', 'viande_poulet', 'viande_agneau', 'cuir_brut',
}
